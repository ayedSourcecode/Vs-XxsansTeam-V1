		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					...
					#else
					createCoolText(['XxsansTeam', 'More in Credits lol']);
					#end
				// credTextShit.visible = true;
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('XxsansTeam', 15);
					addMoreText('AsyPryoYT', 15);
					#else
					addMoreText('present');
					#end
				// credTextShit.text += '\npresent...';
				...
				case 6:
					#if PSYCH_WATERMARKS
					createCoolText(['who no love sans', 'who'], -40);
					#else
					createCoolText(['Xx', 'idk'], -40);
					#end
				case 8:
