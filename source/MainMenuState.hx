...
{
	public static var XxsansVersion:String = '1.0';
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Vs XxsansTeam V" + XxsansVersion, 15);
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					CoolUtil.browserLoad('https://www.youtube.com/@xxsansteamfell9378');
				}
				if (optionShit[curSelected] == 'Discord')
				{
					CoolUtil.browserLoad('https://discord.gg/TXDqmc74');
				}
				else
				{
					selectedSomethin = true;
